...
const PizzaUpdate = ({ dispatch }) => {
  ...
  const fetchPizzaDetails = useCallback(async () => {
    try {
      ...
      const response = await axios.get('https://oibsip-tasty-pizza.onrender.com/api/admin/pizza-details', {
        headers: {
  ...
  const handleUpdateClick = useCallback(async (pizzaId) => {
    try {
      ...
      const response =await axios.put(
        `https://oibsip-tasty-pizza.onrender.com/api/admin/pizza-update/${pizzaId}`,
  ...
  const handleDeleteClick = useCallback(async (pizzaId) => {
    try {
      ...
      const pizzaResponse = await axios.get(`https://oibsip-tasty-pizza.onrender.com/api/admin/pizza-details/${pizzaId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        }
      });
      ...
      await axios.post(`https://oibsip-tasty-pizza.onrender.com/api/admin/deleted-pizzas`, {pizzaData}, {
        headers: {
          Authorization: `Bearer ${token}`,
        }
      });
      ...
      // Delete the pizza
      await axios.delete(`https://oibsip-tasty-pizza.onrender.com//api/admin/pizza-delete/${pizzaId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        }
      });
